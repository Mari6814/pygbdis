...
class GBC(Disassembler):
    def initialize_instructions(self):
        self.add_instruction(0x06, lambda ctx: Disassembly('ld B, 0x{n:x}', n=ctx.pop8()))
        self.add_instruction(0x0E, lambda ctx: Disassembly('ld C, 0x{n:x}', n=ctx.pop8()))
        self.add_instruction(0x16, lambda ctx: Disassembly('ld D, 0x{n:x}', n=ctx.pop8()))
        self.add_instruction(0x1E, lambda ctx: Disassembly('ld E, 0x{n:x}', n=ctx.pop8()))
        self.add_instruction(0x26, lambda ctx: Disassembly('ld H, 0x{n:x}', n=ctx.pop8()))
        self.add_instruction(0x2E, lambda ctx: Disassembly('ld L, 0x{n:x}', n=ctx.pop8()))
        ...
        self.add_instruction(0x36, lambda ctx: Disassembly('ld (HL), 0x{n:x}', n=ctx.pop8()))
        self.add_instruction(0x0A, 'ld A, (BC)')
        self.add_instruction(0x1A, 'ld A, (DE)')
        self.add_instruction(0xFA, lambda ctx: Disassembly('ld A, (0x{nn:x})', nn=ctx.reference(ctx.pop16_ls_first())))
        self.add_instruction(0x3E, lambda ctx: Disassembly('ld A, 0x{n:x}', n=ctx.pop8()))
        ...
        self.add_instruction(0xEA, lambda ctx: Disassembly('ld (0x{nn:x}), A', nn=ctx.reference(ctx.pop16_ls_first())))
        ...
        self.add_instruction(0x31, lambda ctx: Disassembly('ld SP, 0x{nn:x}', nn=ctx.reference(ctx.pop16_ls_first())))
        self.add_instruction(0xF9, 'ld SP, HL')
        self.add_instruction(0xF8, lambda ctx: Disassembly('ldhl SP, 0x{n:x}', n=ctx.pop8()))
        self.add_instruction(0x08, lambda ctx: Disassembly('ld (0x{nn:x}), SP', nn=ctx.reference(ctx.pop16_ls_first())))
        ...
        self.add_instruction(0xC6, lambda ctx: Disassembly('add A, 0x{n:x}', n=ctx.pop8()))
        ...
        self.add_instruction(0xCE, lambda ctx: Disassembly('adc A, 0x{n:x}', n=ctx.pop8()))
        ...
        self.add_instruction(0xD6, lambda ctx: Disassembly('sub 0x{n:x}', n=ctx.pop8()))
        ...
        self.add_instruction(0xE6, lambda ctx: Disassembly('and 0x{n:x}', n=ctx.pop8()))
        ...
        self.add_instruction(0xF6, lambda ctx: Disassembly('or 0x{n:x}', n=ctx.pop8()))
        ...
        self.add_instruction(0xEE, lambda ctx: Disassembly('xor 0x{n:x}', n=ctx.pop8()))
        ...
        self.add_instruction(0xFE, lambda ctx: Disassembly('cp 0x{n:x}', n=ctx.pop8()))
        ...
        # ret pe???
        self.add_instruction(0xE8, lambda ctx: Disassembly('add SP, 0x{n:x}', n=ctx.pop8_signed()))
        ...
        self.add_instruction(0xDF, lambda ctx: Disassembly('rst 0x{n:x}', n=ctx.jump(0x18)))
        self.add_instruction(0xE7, lambda ctx: Disassembly('rst 0x{n:x}', n=ctx.jump(0x20)))
